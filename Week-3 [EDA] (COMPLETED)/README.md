...
Membahas tentang Exploratory Data Analysis [EDA] dan Feature Engineering Machine Learning 

Untuk tugas Week 3 ini telah disediakan sebuah Dataset yang dimana Dataset yang digunakan dalam tugas ini berasal dari Telco Customer Churn Dataset, yang berisi informasi pelanggan perusahaan telekomunikasi dan apakah pelanggan tersebut berhenti menggunakan layanan (churn) atau tidak.
